...
class StompSubMap {
 ...
 public:
  ...
  int FindCoverageStatus(StompPixel& pix);
  ...
  bool Add(StompMap& stomp_map, bool drop_single);
  bool Multiply(StompMap& stomp_map, bool drop_single);
  bool Exclude(StompMap& stomp_map);
...
class StompMap {
 ...
 public:
  ...
  // "weight" reference variable.  If the location is within the StompMap, then
  ...
  // for the StompMap at the input location.  If the location is not within
  ...
  int FindCoverageStatus(StompPixel& pix);
  void FindCoverageStatus(StompVector& pix,
